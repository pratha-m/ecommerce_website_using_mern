  ...
  return (
    <div>
      <Router>
          ...
          <Routes>
            <Route exact path='/' element={<><ImageSlider/><PRoducts userId={userId} isLoggedIn={isLoggedIn} wishlistProducts={wishlistProducts} changeNo={changeNo} setChangeNo={setChangeNo} getProducts={getProducts} productList={productList} successToast={successToast} errorToast={errorToast} isLoadingProducts={isLoadingProducts} setIsLoadingProducts={setIsLoadingProducts}/></>}/>
            ...
            {isLoggedIn && <Route exact path='/profile' element={<Profile name={name} email={email} userId={userId} successToast={successToast} errorToast={errorToast}/>}/>}
            ...
            {isLoggedIn && <Route exact path='/logout' element={<LOgout changeNo={changeNo} setChangeNo={setChangeNo} getProducts={getProducts}/>}/>}
