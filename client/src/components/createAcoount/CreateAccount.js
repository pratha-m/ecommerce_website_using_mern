    ...
    <div className="createaccount_createAccountTextAndFormDiv">
         ...
         <div className="createaccount_createAccountFormDiv">
                 ...
                 <div className="createaccount_eachInfoDiv createaccount_passwordDiv">
                  ...
                  <div className="createaccount_inputDiv"><div className="createaccount_input createaccount_passwordInput"><input onChange={(event)=>{setPassword(event.target.value)}} type="password" placeholder='Password' required={true}/><div className="createaccount_showPasswordIconDiv"></div></div></div></div>
                 <div className="createaccount_eachInfoDiv createaccount_passwordDiv">
                  {/* <div className="createaccount_inputTextDiv">Confirm Password:</div> */}
                  <div className="createaccount_inputDiv"><div className="createaccount_input createaccount_passwordInput"><input onChange={(event)=>{setConfirmPassword(event.target.value)}} type="password" placeholder='Confirm Password' required={true}/><div className="createaccount_showPasswordIconDiv"></div></div></div></div>
